...
def concatenate_databases(
    ...
    """Concatenate two dictionaries of pandas DataFrames into one dict of DataFrames.

    The function concatenates the pandas DataFrames of the second dict of DataFrames to the first dict of DataFrames for the keys they have in common.
    Keys that are unique to either dictionary will be included in the final concatenated dictionary.
